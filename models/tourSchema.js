...
const tourSchema = new mongoose.Schema(
  {
    name: {
      ...
      trim: true,
      maxlength: [40, 'A tour name must have 40 or more characters'], // specifies max length a string can have
      minlength: [10, 'A tour name must have 10 or less characters'],
